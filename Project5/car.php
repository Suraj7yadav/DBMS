...
$sql1="SELECT c1.*,c2.* FROM car c1 inner join car_details c2 on c1.car_id=c2.car_id";
$sql2="SELECT c3.*,c4.* FROM car c3 inner join security_details c4 on c3.car_id=c4.car_id";
