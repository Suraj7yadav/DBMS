...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 26, 2018 at 04:02 PM
...
INSERT INTO `car_details` (`car_id`, `car_condition`, `color`, `regno`, `year_of_purchase`, `price`, `distance_travelled`, `owner_id`) VALUES
(17, 'new', 'red', '11', 11, 11, 11, 8),
(20, 'old', 'blue', 'ka90', 1989, 12000, 1200, 8),
(21, 'old', 'q', 'q', 0, 0, 0, 8),
(18, 'new', 'red', 'vb', 1994, 100, 100, 8);
...
INSERT INTO `status` (`owner_id`, `car_id`, `status`) VALUES
(8, 21, 'unsold');
...
ALTER TABLE `car_details`
  ...
  ADD KEY `car_details_ibfk_2` (`owner_id`),
  ADD KEY `car_id` (`car_id`);
...
--
ALTER TABLE `car_details`
  ADD CONSTRAINT `car_details_ibfk_2` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`owner_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `status`
  ADD CONSTRAINT `status_ibfk_2` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`owner_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `status_ibfk_3` FOREIGN KEY (`car_id`) REFERENCES `car` (`car_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
